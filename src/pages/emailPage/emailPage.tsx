  ...
  return (
    ...
    <div className=' h-[100%] rounded-md bg-white shadow-md flex items-center px-5 justify-center gap-2 flex-col lg:flex-row'>
        <div className=' min-h-[200px] w-full p-2  flex items-center justify-center  '>
           ...
           <div className='pl-2'>
           <h1 className='text-[28px] font-normal  font-sans mb-4'>Enter your Email</h1>
            <p className='text-[1.75rem] font-sans mb-3 '>This will be used contact you for the next steps</p>
            <input type="text" className="border-b border-black focus:outline-none w-full mt-5" placeholder="Type Here" />
           </div>
            </div>
